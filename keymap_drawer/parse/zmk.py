...
GO60_MARKER = "THIS FILE WAS GENERATED BY GO60 LAYOUT EDITOR"
...
class ZmkKeymapParser(KeymapParser):
    ...
    def _parse(self, in_str: str, file_name: str | None = None) -> tuple[dict, KeymapData]:
        ...
        physical_layout = (
            ...
            if GLOVE80_MARKER in in_str
            else {"zmk_keyboard": "go60"} if GO60_MARKER in in_str else self._get_physical_layout(file_name, dts)
        )
